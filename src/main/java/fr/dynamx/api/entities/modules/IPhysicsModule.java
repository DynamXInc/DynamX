...
public interface IPhysicsModule<P extends AbstractEntityPhysicsHandler<?, ?>>
{
    ...
    default IVehicleController createNewController() {return null;}
    ...
    interface IEntityUpdateListener
    {
         ...
         */
        default boolean listenEntityUpdates(Side side) {return true;}
    ...
    interface IEntityPosUpdateListener
    {
         ...
         */
        default boolean listenEntityPosUpdates(Side side) {return side.isClient();}
