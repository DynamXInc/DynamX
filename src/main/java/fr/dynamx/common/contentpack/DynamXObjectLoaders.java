...
public class DynamXObjectLoaders {
    ...
    //TODO CLEAN TYPE PARAMETERS
    public static ObjectLoader<ModularVehicleInfo, ItemCar, ModularVehicleInfo> WHEELED_VEHICLES = new ObjectLoader<>("vehicle_", ModularVehicleInfo::new, ItemCar::getItemForCar, new SubInfoTypesRegistry<>());
    public static ObjectLoader<ModularVehicleInfo, ItemTrailer, ModularVehicleInfo> TRAILERS = new ObjectLoader<>("trailer_", ModularVehicleInfo::new, ItemTrailer::new, WHEELED_VEHICLES.getSubInfoTypesRegistry());
    public static ObjectLoader<ModularVehicleInfo, ItemBoat, ModularVehicleInfo> BOATS = new ObjectLoader<>("boat_", ModularVehicleInfo::new, ItemBoat::new, WHEELED_VEHICLES.getSubInfoTypesRegistry());
