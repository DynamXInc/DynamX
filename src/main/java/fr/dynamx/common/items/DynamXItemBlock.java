...
public class DynamXItemBlock extends ItemBlock implements IResourcesOwner, IInfoOwner<BlockObject<?>> {
    ...
    public String getTranslationKey(ItemStack stack) {
        return (stack.getMetadata() != 0 && dynamxMainBlock.textureNum > 1) ? super.getTranslationKey(stack) + "_" + dynamxMainBlock.getInfo().getTextureVariantsFor(null).get((byte) stack.getMetadata()).getName().toLowerCase()
