...
public class MessageSyncConfig implements IDnxPacket, IMessageHandler<MessageSyncConfig, IMessage> {
    ...
    public MessageSyncConfig(boolean reloadResources, int syncDelay, Map<Block, float[]> blockInfos, List<Block> slopes, int slopesLength, boolean slopesPlace, IPhysicsSimulationMode physicsSimulationMode) {
