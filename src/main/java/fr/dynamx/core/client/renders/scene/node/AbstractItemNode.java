...
/**
 * A {@link SceneNode} that can be rendered as an item, with an {@link BaseRenderContext.ItemRenderContext} <br>
...
public abstract class AbstractItemNode<C extends IRenderContext, A extends IModelPackObject> implements SceneNode<C, A> {
    ...
    /**
     * Renders this node as an item with an {@link BaseRenderContext.ItemRenderContext} <br>
