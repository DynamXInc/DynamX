package fr.dynamx.core.client.sound;
...
public class EngineSound extends VehicleSound {
    ...
    private final fr.dynamx.core.common.contentpack.type.vehicle.EngineSound soundIn;

    public EngineSound(fr.dynamx.core.common.contentpack.type.vehicle.EngineSound sound, BaseVehicleEntity<?> vehicle, BasicEngineModule engine) {
    ...
    public boolean tryStop() {
        if (getVolumeFactor() <= 0 || vehicleEntity.getMcEntity().hm$isDead()) {
