...
import fr.dynamx.core.client.renders.mesh.shapes.ArrowMesh;
import fr.dynamx.core.client.renders.mesh.shapes.GridGLMesh;
import fr.dynamx.core.client.renders.mesh.shapes.OctasphereMesh;
...
import fr.dynamx.core.client.renders.model.renderer.DxItemModelLoader;
...
public class DynamXRenderUtils {
    ...
    /**
     * @deprecated You should render the entity using its SceneGraph (see {@link DxItemModelLoader} for an example)
     */
    @Deprecated
     ...
     * see {@link GltfModelRenderer#renderVanillaOrShader(int, boolean)}.
     */
