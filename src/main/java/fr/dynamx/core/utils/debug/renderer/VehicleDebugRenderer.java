package fr.dynamx.core.utils.debug.renderer;
...
import fr.dynamx.core.common.contentpack.parts.PartPropsContainer;
        ...
        public void render(BaseVehicleEntity<?> entity, RenderPhysicsEntity<BaseVehicleEntity<?>> renderer, double x, double y, double z, float partialTicks) {
            ...
            GlStateManager.pushMatrix();
            {
                ...
                if (serverPos != null) {
                    ...
                    BaseRenderContext.EntityRenderContext context = renderer.getRenderContext(entity);
                    if (context != null)
