...
public class ShapeUtils {
    ...
    public static CompoundCollisionShape generateComplexModelCollisions(DxModelPath path, String objectName, Vector3f scale, Vector3f centerOfMass, float shapeYOffset) {
        ...
        if (shapeGenerator == null) {
            ...
            String modelPath = DynamXMain.getInstance().getResourcesDirectory() + File.separator + path.getPackName() + File.separator + "assets" + //todo prevents from saving in zip files : we use the pack name
