 ...
 */
public class ListenableHmEvent<T> implements HmEvent<T> {
    private final List<T> listeners = new ArrayList<>();
    private final Function<ListenableHmEvent<T>, T> invokerFactory;
    private T invoker;

    private ListenableHmEvent(Function<ListenableHmEvent<T>, T> invokerFactory) {
     ...
     */
    public static <T> ListenableHmEvent<T> create(Function<ListenableHmEvent<T>, T> invokerFactory) {
        return new ListenableHmEvent<>(invokerFactory);
    }
